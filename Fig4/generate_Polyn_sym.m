function generate_Polyn_sym(k)
    
    pav = sprintf('Cheb_Rn_%d_sym.m',k);
    fid = fopen(pav,'w');
    
    pav = sprintf('function r=Cheb_Rn_%d_sym(X,n,N)\n\n',k);
    fprintf(fid,pav);
